  ...
  return (
    ...
    <div className="flex flex-col">
        <div className="flex h-15">
            <nav id="navbar" className="fixed inline top-0 left-0 right-0 z-[1000] bg-white dark:bg-dark-card backdrop-blur-xl border-b border-gray-200/50 dark:border-dark-nav-border py-3.5 transition-all duration-300">
                    ...
                    <div className="nav-links hidden md:flex items-center space-x-8">
                        ...
                        {user && (
                            <>
                                ...
                                <Link>
                                    <button onClick={handleLogout} className="bg-black text-blue-500 py-1 px-3 rounded">
                                        Logout
                                    </button>
                                </Link>
                            </>
